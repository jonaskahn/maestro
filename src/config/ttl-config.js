...
const PRIMARY_TTL_VALUES = {
  TASK_PROCESSING_BASE_TTL: 180_000,
...
const DERIVED_ENV_VARS = {
  ...
  TASK_FREEZING_STATE_TTL: ["MO_TASK_FREEZING_STATE_TTL_MS"],
...
class TTLConfig {
  ...
  static getAllTTLValues(overrides = {}) {
    ...
    const derived = {
      ...
      TASK_FREEZING_STATE_TTL: this.getDerivedTTL("TASK_FREEZING_STATE_TTL", () => base.TASK_PROCESSING_BASE_TTL * 3),
