...
const DERIVED_ENV_VARS = {
  ...
  DISTRIBUTED_LOCK_REFRESH_INTERVAL: ["JO_DISTRIBUTED_LOCK_REFRESH_INTERVAL_MS"],
...
class TTLConfig {
  ...
  static getAllTTLValues(overrides = {}) {
    ...
    const derived = {
      ...
      TASK_FREEZING_STATE_TTL: this.getDerivedTTL("TASK_FREEZING_STATE_TTL", () => base.TASK_PROCESSING_BASE_TTL * 5),
