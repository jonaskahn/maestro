...
describe("KafkaMonitorService", () => {
  ...
  describe("Constructor", () => {
    test("should initialize with configuration", () => {
      // Given: Test setup for should initialize with configuration
  ...
  describe("getBrokerType", () => {
    test("should return 'kafka'", () => {
      // Given: Test setup for should return 'kafka'
      // When: Action being tested
      // Then: Expected outcome
  ...
  describe("getConsumerLag", () => {
    ...
    test("should handle errors during lag calculation", async () => {
      // Given: Test setup for should handle errors during lag calculation
      // When: Action being tested
      // Then: Expected outcome
  ...
  describe("getResourceMetrics", () => {
    test("should return resource metrics with memory usage", async () => {
      // Given: Test setup for should return resource metrics with memory usage
      // When: Action being tested
      // Then: Expected outcome
  ...
  describe("_fetchCurrentLag", () => {
    ...
    test("should calculate lag when topic exists", async () => {
      // Given: Test setup for should calculate lag when topic exists
      // When: Action being tested
      // Then: Expected outcome
      mockIsTopicExisted.mockResolvedValue(true);
    ...
    test("should return 0 when topic doesn't exist", async () => {
      // Given: Test setup for should return 0 when topic doesn't exist
      // When: Action being tested
      // Then: Expected outcome
    ...
    test("should return 0 and log warning when missing topic or group", async () => {
      // Given: Test setup for should return 0 and log warning when missing topic or group
      // When: Action being tested
      // Then: Expected outcome
  ...
  describe("disconnect", () => {
    ...
    test("should disconnect admin client", async () => {
      // Given: Test setup for should disconnect admin client
      // When: Action being tested
      // Then: Expected outcome
    ...
    test("should handle errors during disconnect", async () => {
      // Given: Test setup for should handle errors during disconnect
      // When: Action being tested
      // Then: Expected outcome
